...
"<P>Die dritte Ebene ist die Monitoring-Schicht. Ist der Mikrocontroller an ein Netzwerk angeschlossen, so ist er in der Lage sich per DHCP mit dem Netzwerk zu verbinden und stellt dann eine Webseite zur Verfügung. Auf dieser Webseite gibt es einen geschützten Bereich, auf dem die Positionen der Servomotoren und der Laserstatus angezeigt wer</P>"
"<BR><P><A HREF=\"admin.html\">Hier</A> geht es weiter zur Monitoring-Seite..<BR><A HREF=\"https://github.com/KonradMerkel/Moskito\">Hier</A> kann man den Quelltext und die schriftliche Arbeit sehen...</P>";

P(admin) = "<H1 STYLE=\"background: transparent\"><FONT FACE=\"DejaVu Sans, sans-serif\">Monitoring  des Moskitos</FONT></H1><H2 CLASS=\"western\"><FONT FACE=\"Cantarell\">Hier ist es Ihnen möglich die aktuellen Parameter und des Moskitos zu sehen...</FONT></H2>";
